        ...
        <LoginContent>
            ...
            <SignInForm>
                <InputContainer>
                    ...
                    <SiginInput placeholder="Username"/>
                </InputContainer>
                <InputContainer>
                    <SiginLabel>Password</SiginLabel>
                    <SiginInput placeholder="Password"/>
                </InputContainer>
                <SignInButton>Sign Up</SignInButton>
                <SignupOption>New User? <SignupButton onClick={()=>{handleLogin()}}>Sign In</SignupButton></SignupOption>
            </SignInForm>
        </LoginContent>
    </LoginContainer>
);
